...
@implementation MXUIHelper (QMUIMoreOperationAppearance)
...
@implementation MXUIHelper (QMUIAlertControllerAppearance)
...
@implementation MXUIHelper (QMUIDialogViewControllerAppearance)
...
+ (void)customDialogViewControllerAppearance {
    ...
    appearance.backgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<MXThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:MXThemeIdentifierDark]) {
            return UIColorMake(34, 34, 34);
        }
        return UIColorWhite;
    }];
    appearance.headerViewBackgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<MXThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:MXThemeIdentifierDark]) {
            return UIColorMake(34, 34, 34);
        }
    ...
    appearance.headerSeparatorColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<MXThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:MXThemeIdentifierDark]) {
...
@implementation MXUIHelper (QMUIEmotionView)
...
@implementation MXUIHelper (QMUIImagePicker)
...
@implementation MXUIHelper (UITabBarItem)
...
@implementation MXUIHelper (Button)
...
@implementation MXUIHelper (Emotion)
...
@implementation MXUIHelper (SavePhoto)
...
@implementation MXUIHelper (Calculate)
...
@implementation MXUIHelper (Theme)
