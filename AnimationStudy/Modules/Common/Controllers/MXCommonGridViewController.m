...
@interface MXCommonGridButton : QMUIButton

@end
//
//@implementation MXCommonGridViewController
//
//- (void)didInitialize {
//    [super didInitialize];
//    [self initDataSource];
...
////        self.gridView addSubview:[self gen]
//    }
//
...
//    } else {
//        CGFloat minimumItemWidth = flat([QMUIHelper screenSizeFor55Inch].width / 3);
//        CGFloat maximumItemWidth = flat(gridViewWidth / 5.0);
//        CGFloat freeSpacingWhenDisplayingMinimunCount = gridViewWidth / maximumItemWidth - floor(gridViewWidth / maximumItemWidth);
//        CGFloat freeSpacingWhenDisplayingMaximumCount = gridViewWidth / minimumItemWidth - floor(gridViewWidth / minimumItemWidth);
//
//        if (freeSpacingWhenDisplayingMinimunCount < freeSpacingWhenDisplayingMaximumCount) {
...
//}
//
//- (MXCommonGridButton *)generateButtonAtIndex:(NSInteger)index {
...
//
//    MXCommonGridButton *button = [[MXCommonGridButton alloc] init];
...
//}
//
//- (void)handleGirdButtonEvent:(MXCommonGridButton *)button {
...
//@end
//
//@implementation MXCommonGridButton
//
...
@implementation MXCommonGridViewController (UISubclassingHooks)
