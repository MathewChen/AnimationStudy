...
extern NSString *const MXSelectedThemeIdentifier;
extern NSString *const MXThemeIdentifierDefault;
extern NSString *const MXThemeIdentifierGrapefruit;
extern NSString *const MXThemeIdentifierGrass;
extern NSString *const MXThemeIdentifierPinkRose;
extern NSString *const MXThemeIdentifierDark;
...
extern const CGFloat MXButtonSpacingHeight;

@interface MXCommonUI : NSObject

+ (void)renderGlobalAppearances;

@end

@interface MXCommonUI (ThemeColor)

+ (UIColor *)randomThemeColor;
@end

@interface MXCommonUI (Layer)
