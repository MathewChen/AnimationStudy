...
- (void)setLevelType:(BottomBarLevelType)levelType {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        if (levelType == BottomBarLevelTypeMin) {
            ...
            self.handleView.qmui_top = self.minY - self.extraHeight;
            if (self.offsetChangeBlock) {
            ...
            self.handleView.qmui_top = self.midY - self.extraHeight;
            if (self.offsetChangeBlock) {
            ...
            self.handleView.qmui_top = self.maxY - self.extraHeight;
            if (self.offsetChangeBlock) {
