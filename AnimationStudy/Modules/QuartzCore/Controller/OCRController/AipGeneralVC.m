...
@property(nonatomic, strong) UIButton *captureButton;//捕获（拍照）
@property(nonatomic, strong) UIButton *closeButton;//关闭
@property(nonatomic, strong) UIButton *albumButton;//专辑
@property(nonatomic, strong) UIButton *lightButton;//灯
@property(nonatomic, strong) UIButton *checkCloseBtn;
@property(nonatomic, strong) UIButton *checkChooseBtn;
@property(nonatomic, strong) UIButton *transformButton;
@property(nonatomic, strong) UIView *checkView;
@property(nonatomic, strong) UIView *toolsView;
@property(nonatomic, strong) AipCameraPreviewView *previewView;
@property(nonatomic, strong) AipCutImageView *cutImageView;
@property(nonatomic, strong) AipImageView *maskImageView;
...
- (void)viewDidLoad {
    ...
    self.previewView = [[AipCameraPreviewView alloc] init];
